...
#define MyAppVerH "Harbour 3.0"
#define MyAppVerC "MINGW 4.5.2"
#define MyAppFile "oohg_hm30_v200608rc1"
#define MyAppPublisher "The OOHG Developer Team"
#define MyAppURL "https://oohg.github.io/"
#if DirExists('W:\OOHG_HM30')
   #define MySource "W:\OOHG_HM30\*"
#elif DirExists('D:\OOHG_HM30')
   #define MySource "D:\OOHG_HM30\*"
#elif DirExists('C:\OOHG_HM30')
   #define MySource "C:\OOHG_HM30\*"
#else
...
AppId={{EFA0963C-E7D7-474F-896B-973EED51BE18}
AppName={#MyAppName}
