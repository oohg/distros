...
#define MyAppVerH "xHarbour 1.2.3 build 20181212"
#define MyAppVerC "MinGW 7.3.0"
#define MyAppFile "oohg_xm_v200608rc1"
#define MyAppPublisher "The OOHG Developer Team"
#define MyAppURL "https://oohg.github.io/"
#if DirExists('W:\OOHG_XM')
   #define MySource "W:\OOHG_XM\*"
#elif DirExists('D:\OOHG_XM')
   #define MySource "D:\OOHG_XM\*"
#elif DirExists('C:\OOHG_XM')
   #define MySource "C:\OOHG_XM\*"
#else
...
AppId={{B0DEA3FA-82B9-4BA9-B222-229B8CF6F852}
AppName={#MyAppName}
